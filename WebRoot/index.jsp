  ...
  <body>
  	<div class="wrapper">
            ...
            <div class="header_container">
                <!--头部开始-->
                        <div class="top_bar clear">
                            <!--头部小导航-->
                            <div class="welcom fl">${sessionScope.user.name }，欢迎进入LEISUPET SHOP! </div>
        ...
        <div class="section_container">
            ...
            <!-- 产品列表 -->
            <c:forEach items="${applicationScope.allProductList}" var="list">
            <div class="products_list products_slider clear">
                <h2 class="sub_title">${list[0].category.type }</h2> 
                <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
                	<c:forEach items="${list}" var="product">
                    <li> <a  href="${shop}/product_get.action?id=${product.id}"class="product_image"><img src="${shop}/images/${product.pic }" /></a>
                        <div class="product_info">
                            <h3><a href="#">${product.name }</a></h3>
                            <small>价格：${product.price }</small> </div>
